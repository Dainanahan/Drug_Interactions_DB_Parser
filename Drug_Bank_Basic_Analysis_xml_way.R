...
parse_drug_external_identifiers<- function() {
  ...
  save_drug_sub(con = con, df = drug_external_identifiers
...
parse_drug_targets_links <- function() {
  ...
  save_drug_sub(con = con, df = drug_targets_links, table_name = "drug_targets_links",
                save_table_only = TRUE, field.types = list(title =  paste("varchar(",
                                                                          max(nchar(drug_targets_links$title)) + 100, ")", sep = ""),
                                                           url =  paste("varchar(",
                                                                          max(nchar(drug_targets_links$url)) + 100, ")", sep = "")))
...
parse_drug_enzymes_polypeptides <- function() {
  ...
  save_drug_sub(con = con, df = drug_enzymes_polypeptides, 
                table_name = "drug_enzymes_polypeptides", save_table_only = TRUE,
...
parse_drug_enzymes_polypeptides_external_identifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_enzymes_polypeptide_external_identifiers, 
                table_name = "drug_enzymes_polypeptides_external_identifiers", save_table_only = TRUE)
...
parse_drug_targets_polypeptides_external_identifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_targets_polypeptide_external_identifiers,
                table_name = "drug_targets_polypeptides_external_identifiers", save_table_only = TRUE)
...
parse_drug_carriers_polypeptides_external_identifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_carriers_polypeptide_external_identifiers,
                table_name = "drug_carriers_polypeptides_external_identifiers", save_table_only = TRUE)
...
parse_drug_transporters_polypeptides_external_identifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_transporters_polypeptide_external_identifiers, 
                table_name = "drug_transporters_polypeptides_external_identifiers", save_table_only = TRUE)
...
parse_drug_enzymes_polypeptides_synonyms <- function() {
  ...
  save_drug_sub(con = con, df = drug_enzymes_polypeptide_synonyms, 
                table_name = "drug_enzymes_polypeptides_synonyms", save_table_only = TRUE)
...
parse_drug_targets_polypeptides_synonyms <- function() {
  ...
  save_drug_sub(con = con, df = drug_targets_polypeptide_synonyms, 
                table_name = "drug_targets_polypeptides_synonyms", save_table_only = TRUE)
...
parse_drug_carriers_polypeptides_synonyms <- function() {
  ...
  save_drug_sub(con = con, df = drug_carriers_polypeptide_synonyms, 
                table_name = "drug_carriers_polypeptides_synonyms", save_table_only = TRUE)
...
parse_drug_transporters_polypeptides_synonyms <- function() {
  ...
  save_drug_sub(con = con, df = drug_transporter_polypeptide_synonyms, 
                table_name = "drug_transporters_polypeptides_synonyms", save_table_only = TRUE)
...
parse_drug_enzymes_polypeptides_pfams <- function() {
  ...
  save_drug_sub(con = con, df = drug_enzymes_polypeptide_pfams, 
                table_name = "drug_enzymes_polypeptides_pfams", save_table_only = TRUE)
...
parse_drug_targets_polypeptides_pfams <- function() {
  ...
  save_drug_sub(con = con, df = drug_targets_polypeptide_pfams, 
                table_name = "drug_targets_polypeptides_pfams", save_table_only = TRUE)
...
parse_drug_carriers_polypeptides_pfams <- function() {
  ...
  save_drug_sub(con = con, df = drug_carriers_polypeptide_pfams, 
                table_name = "drug_carriers_polypeptide_pfams", save_table_only = TRUE)
...
parse_drug_transporters_polypeptides_pfams <- function() {
  ...
  save_drug_sub(con = con, df = drug_transporters_polypeptides_pfams, 
                table_name = "drug_transporters_polypeptides_pfams", save_table_only = TRUE)
...
parse_drug_enzymes_polypeptides_go_classifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_enzymes_polypeptides_go_classifiers, 
                table_name = "drug_enzymes_polypeptides_go_classifiers", save_table_only = TRUE)
...
parse_drug_targets_polypeptides_go_classifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_targets_polypeptides_go_classifiers, 
                table_name = "drug_targets_polypeptides_go_classifiers", save_table_only = TRUE)
...
parse_drug_carriers_polypeptides_go_classifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_carriers_polypeptides_go_classifiers, 
                table_name = "drug_carriers_polypeptides_go_classifiers", save_table_only = TRUE)
...
parse_drug_transporters_polypeptides_go_classifiers <- function() {
  ...
  save_drug_sub(con = con, df = drug_transporters_polypeptides_go_classifiers, 
                table_name = "drug_transporters_polypeptides_go_classifiers", save_table_only = TRUE)
